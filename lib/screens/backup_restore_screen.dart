  ...
  Future<void> _restoreBackup(BackupMetadata backup) async {
    ...
    if (mounted) {
      ...
      if (success) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('✓ Backup restored successfully! Restart app for changes to take effect.'),
            backgroundColor: Colors.green,
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Auto-backup: ${_autoBackupEnabled ? 'Enabled' : 'Disabled'}',
                          style: TextStyle(color: Colors.grey[600]),
                        ),
                        if (_lastBackup != null) ...[
                          const SizedBox(height: 8),
                          Text(
                            'Last backup: ${_lastBackup!.timeAgo}',
                            style: TextStyle(color: Colors.grey[600]),
                          ),
                        ],
                        const SizedBox(height: 8),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(_backupService.isBackingUp ? 'Creating...' : 'Create Backup'),
                                ...
                                onPressed: () async {
                                  final confirmed = await showDialog<bool>(
                                    ...
                                    builder: (context) => AlertDialog(
                                      ...
                                      content: const Text('Are you sure you want to delete all backups?'),
                                      actions: [
                                        TextButton(
                                          onPressed: () => Navigator.pop(context, false),
                                          child: const Text('Cancel'),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                leading: Container(
                                  ...
                                  child: const Icon(Icons.folder_zip, color: Colors.blue),
                                ),
